...
const TripsDistanceSummary = ({ navigation }) => {
            ...
            <View style={styles.itemContainer}>
                ...
                {/* <View style={styles.row}>
                    ...
                    <View style={{ paddingHorizontal: 10 }}>
                        <Typography size={15} style={{ paddingVertical: 5 }} color={colors.textPrimary} variant="regular">{item?.StartAddress}</Typography>
                    </View>
                </View> */}

                <View style={styles.row}>
                    <Image source={images.GeoFence} resizeMode="contain"
                        style={{ width: 20, height: 20 }} />
                    <View style={{ paddingHorizontal: 10 }}>
                        <Typography size={15} style={{ paddingVertical: 5 }} color={colors.textPrimary} variant="regular">Distance: {parseFloat(item?.Distance).toFixed(2)} Km</Typography>
                    </View>
                </View>
            </View>
        );
...
export default TripsDistanceSummary;
